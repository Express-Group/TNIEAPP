...
$show_simple_tab        .='<div class="lead_stories features lead_stories_upgraded" '.$widget_bg_color.' id="lead_stori_'.$widget_instance_id.'">';
	// widget title 
		...
		else 
		{
			$show_image	= image_url. imagelibrary_image_path.'logo/nie_logo_600X390.jpg';
				...
				$show_simple_tab .='<div class="item '.$add_active.'">
									<h4 class="subtopic subtop"><a  href="'.$live_article_url.'"  class="article_click" >'.$display_title.'</a></h4><a  href="'.$live_article_url.'"  class="article_click" >'.$img_icon.'<img width="600" height="390" class="img-over"  src="'.$dummy_image.'" data-src="'.$show_image.'"  title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a>';
