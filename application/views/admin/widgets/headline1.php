...
if($get_content_ids!='')
{
	...
	{	
		...
		foreach($widget_contents as $get_content)
		{
			...
			$show_image="";
			// changed 10-09-2016 if($original_image_path !='' && getimagesize(image_url_no . imagelibrary_image_path .$original_image_path)) chnage basepath with image_url 
		   ...
		   $custom_summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag
			...
			{*/
				...
				$show_simple_tab .='<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 SpecialLeadStory_1"><h4>'.$display_title.'</h4>';		
				 ...
				 $show_simple_tab .= '<div class="lead_stories_upgraded lead_stories">';
