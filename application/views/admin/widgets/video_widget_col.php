...
{	
	...
	$show_simple_tab.= '<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-12 video-widget-up">
	<a   href="'.$live_article_url.'"><img width="600" height="300" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'">
	<img width="25" height="25" class="GalleryIcon" data-src="'.$play_video_image.'" src="'.image_url.'images/FrontEnd/images/lazy.png"></a>
