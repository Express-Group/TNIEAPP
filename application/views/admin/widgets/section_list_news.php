		...
		if(count($widget_contents)>0)
		{
			foreach($widget_contents as $get_content)
			{
				...
				//  Assign article links block ends hers
				 $show_simple_tab .='<p> <i class=""></i> <a  href="'.$live_article_url.'" class="article_click" >'.$display_title.'</a></p>';
				$i++;						  
			}
