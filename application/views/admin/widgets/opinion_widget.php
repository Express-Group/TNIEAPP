		 ...
		 {	
				foreach($widget_contents as $get_content)
				{
					...
					$show_image="";
						...
						$url_section_value	=	$url_section_value."/".$authorId;
						}
					...
					//  Assign article links block ends hers
						...
						$show_simple_tab.='<div class="most1">';
								...
								$show_simple_tab .='<a  href="'.$live_article_url.'" class="article_click" ><img width="150" height="150" src="'.$show_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a>';
