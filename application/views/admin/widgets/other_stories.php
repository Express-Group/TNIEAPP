...
if(count(array_filter($widget_instance_contents_array)) > 0)
{
	foreach(array_filter($widget_instance_contents_array) as $from_get_content)
	{
		...
		$display_title = '<a  href="' . $live_article_url . '" class="article_click" >' . strip_tags($display_title) . '</a>';
		
		$show_simple_tab .= '<div class="most1"> ';
		//$show_simple_tab .= '<a  href="' . $live_article_url . '" ><img src="' . $show_image . '" data-src="'.$show_image.'"  title = "' . $imagetitle . '" alt = "' . $imagealt . '"></a><p>' . $display_title . '</p></div>';
		$show_simple_tab .= '<a  href="' . $live_article_url . '" ><img src="' . $dummy_image . '" data-src="'.$show_image.'"   title = "' . $imagetitle . '" alt = "' . $imagealt . '" width="100" height="65"></a><p>' . $display_title . '</p></div>';
