...
/*get site url */
	...
	elseif($render_mode=='dn'):
		...
		$api_url='https://www.dinamani.com/new-sitemap.xml?latest=true';
		...
		var dummy_image1='https://images.samakalikamalayalam.com/uploads/user/imagelibrary/logo/nie_logo_600X390.jpg';
				...
				$.post(rule_url,{ url: "<?php print $api_url ?>" }, function(data){
					...
					if(render_mode=='cs'){
						...
						template_new +='<h4 class="external_api_header_nie '+((render_mode=='dn')?'din-external':'')+'"><a target="_BLANK" href="'+external_url+'"><img width="102" height="41" src="<?php echo $site_image ?>"></a></h4>';
					}
