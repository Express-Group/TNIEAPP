...
.social-icons-wrapper {	width:100% !important;    text-align: center; }
...
@media only screen and (max-width: 1550px) and (min-width: 1297px){
	.main_logo { margin-top: 13px;}
}

@media only screen and (min-width: 1551px){
	.social-icons-wrapper {	 margin-left: 0 !important; }
	.main_logo{margin-top: 15px;}
}

@media only screen and (max-width: 991px){
	.main_logo img{	padding-top: 9px;margin-left: -13%;	width: 127%;}
}
@media only screen and (max-width: 500px){
	.MobileSearch{   padding: 11px 5px 2px;	}
}
...
<!--<div class="social_icons SocialCenter mobile-share"><span> <a class="android" href="https://play.google.com/store/apps/details?id=com.newindianexpress.news" rel="nofollow" target="_blank"><i class="fa fa-android" aria-hidden="true"></i></a> <a class="apple" href="https://itunes.apple.com/in/app/new-indian-express-official/id968640811?mt=8" rel="nofollow" target="_blank" ><i class="fa fa-apple" aria-hidden="true"></i></a></span> <a class="fb" href="<?php echo $header_details['facebook_url'];?>" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a> <a class="google" href="<?php echo $header_details['google_plus_url'];?>" rel="nofollow" target="_blank"><i class="fa fa-google-plus"></i></a> <a class="twit" href="<?php echo $header_details['twitter_url'];?>" rel="nofollow" target="_blank"><i class="fa fa-twitter"></i></a><!--<a class="pinterest" href="http://www.pinterest.com/newindianexpres" rel="nofollow" target="_blank"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a>
		...
		<div class="social_icons SocialCenter mobile-share">
			<div class="dropdown menucat">
				 ...
				 <ul class="dropdown-menu">
						<li class="all-menu-sub"><a style="color:red !important;" href="<?php echo base_url()."sport/olympics"; ?>"><?php echo "Olympics"; ?></a></li>
						<li class="all-menu-sub"><a href="<?php echo base_url()."2020-with-tnie"; ?>"><?php echo "2020 with TNIE"; ?></a></li>
						<li class="all-menu-sub"><a href="<?php echo base_url()."topic/coronavirus"; ?>"><?php echo "Coronavirus"; ?></a></li>
						...
						<li class="dropdown-submenu all-menu">
							<a  href="<?php echo base_url()."lifestyle"; ?>"><?php echo "Life style"; ?> <i class="fa fa-angle-right"></i></a>
							<ul class="dropdown-menu all-sub-menu">
						...
						<li class="all-menu-sub"><a href="<?php echo base_url()."explainers"; ?>"><?php echo "explainers"; ?></a>
						<li class="dropdown-submenu all-menu">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
    <div class="main_logo">
      <?php 
		echo '<a href="'.base_url().'"><img src="'.image_url.'images/FrontEnd/images/sunday_std_logo.jpg"></a>';
	?>
			...
			<ul class="MobileNav">
			   ...
			   <li>
				...
				<li class="MobileSearch">
					<a class="SearchHide" href="javascript:void(0);"><i class="fa fa-search" aria-hidden="true"></i></a>
				</li>
			</ul>
			<div class="large-screen-search">
				<div class="social-icons-wrapper margin-bottom-10">
					 <a class="social-icon-set" href="https://play.google.com/store/apps/details?id=com.newindianexpress.news" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/Android_new.png"></a>
					 
					 <a class="social-icon-set" href="https://itunes.apple.com/in/app/the-new-indian-express-app/id1239342233?mt=8" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/Apple_new.png"></a>
					 
					 <a class="social-icon-set" href="<?php echo $header_details['facebook_url'];?>" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/Fb_new.png"></a>
					 
					 <a href="<?php echo $header_details['twitter_url'];?>" target="_blank" class="social-icon-set social-icon-set-youtube"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/twitter_new.png"></a>
		   
					<!--<a class="social-icon-set social-icon-set-fb" href="<?php echo $header_details['google_plus_url'];?>" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/G_plus_new.png"></a>-->
   
					 <a class="social-icon-set" href="https://instagram.com/newindianexpress/" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/Insta_new.png"></a>
					 
					 <a class="social-icon-set" href="https://www.youtube.com/user/thenewindianxpress" rel="nofollow" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/YT_new.png"></a>
					 
					 <a class="social-icon-set" href="<?php echo $header_details['rss_url'];?>" target="_blank"><img src="<?php echo image_url ?>/images/FrontEnd/images/social-icon-set/rss_new.png"></a>
