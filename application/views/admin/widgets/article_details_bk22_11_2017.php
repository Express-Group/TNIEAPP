...
<?php
					...
					if($MultiSectionMapping!=0){
						...
						if(in_array("172", $MultiSectionMapping)){
							?>
							<!-- Begin ZEDO STATES-->
						...
						if(in_array("180", $MultiSectionMapping)){
							?>
							<!-- Begin ZEDO CITIES-->
...
<script type='text/javascript'>
    var _sf_async_config = _sf_async_config || {};
		_sf_async_config.sections = '<?php echo $child_section_name; ?>'; 
		_sf_async_config.authors = '<?php echo $author_name; ?>'; 
		(function() {
