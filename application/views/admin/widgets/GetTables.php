...
foreach($data as $View):
	...
	$Percentage1=($JsonTable[0]['field4']/$View->total)/100;
	$Percentage2=($JsonTable[1]['field4']/$View->total)/100;
	$Percentage3=($JsonTable[2]['field4']/$View->total)/100;
	$Percentage4=($JsonTable[3]['field4']/$View->total)/100;
	?>
