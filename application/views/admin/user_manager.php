...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		{ ?>
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>niecpan/user_manager/user_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
			 <?php }?>
	...
	function delete_userdetails(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>niecpan/user_manager/delete_user/"+id;
		}
	}
</script>
<script>
...
function user_datatables()
{
	...
	$('#example').dataTable(
	{
      ...
      if ($(this).find('tbody tr').length<=1) {
		...
		"ajax":
		{
			"url": "<?php echo base_url(); ?>niecpan/user_manager/user_datatable",
			"type": "POST",
			"data":
			{
				"from_date": fromdate,
