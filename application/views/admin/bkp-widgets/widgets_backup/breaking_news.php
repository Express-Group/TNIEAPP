    ...
    $.fn.marquee = function (klass) {
        ...
        this.each(function (i) {
            var $marquee = $(this),
                ...
                $marqueeRedux = $marquee.after('<div ' + (klass ? 'class="' + klass + '" ' : '') + 'style="display: block-inline; height: ' + height + 'px; overflow: hidden;"><div style="float: left; white-space: nowrap;">' + $marquee.html() + '</div></div>').next(),
...
<div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 breaking-right-0">
        <div class="line" style="visibility:hidden;">
            <h3 class="breaking">BREAKING NEWS</h3>
			<div id="doc">
        <div class="demo" id="breaking_news">
			<?php /*?><?php 
...
$(document).ready(function(){
 ...
 $.ajax({
			...
			method		: 'get',
			data		: { type: "1", param: '<?php echo $content['page_param'];?>',mode:'<?php echo $content['mode'];?>', is_home: '<?php echo $content['is_home_page'];?>',},
			beforeSend	: function() {				
			},
			...
			if(result.trim()!=''){
				   ...
				   $(".line").fadeIn();
				   $('#breaking_news').html(result).hide().fadeIn({ duration: 1000 });
				   b_init();m_init();
			}else{
