	...
	if(isset($activesectionid)) {
		...
		if($activesectionid != '') {
              $Section_Details =  $this->widget_model->get_sectionDetails($activesectionid, $view_mode); // live db
				...
				/*$section_c = 13 - count($section_mapping);
				$main_menu = $this->widget_model->multiple_section_mapping();
				$sliced_array = array_slice($main_menu, 0, $section_c);
				$section_mapping = array_merge($sliced_array, $section_mapping);*/
				//print_r($sliced_array);exit;
        ...
        <ul class="nav navbar-nav menus">
		  ...
		  if(isset($section_mapping)) { 
			 $Section_Count  = 0;
			   ...
			   $MainSectionPageURL = base_url(). $url_section_value;												
				 ...
				 ?>
          <li class="<?php  echo "StatesHover";   ?>" ><a class="MenuItem <?php if($Section_Details['Sectionname']==$tech_details['Sectionname']){ echo "active";} ?>" id="maintabs-<?php echo $tech_details['Section_id']; ?>" onmouseover="show_main_menu(<?php echo $tech_details['Section_id']; ?>, 'main')"  href="<?php echo base_url().$tech_details['URLSectionStructure']; ?>"><?php echo "Tech"; ?></a>
            ...
            <?php
						...
						{  
				 ?>
          <li class="<?php  if(!empty( $mapping['sub_section']) && $Section_Details['Sectionname'] != "Magazine" ) { echo "CitiesHover";  } else { echo "StatesHover";  } ?>" ><a class="MenuItem active" id="maintabs-<?php echo $mapping['Section_id']; ?>" <?php if(count($mapping['sub_section']) == 0) { ?> onmouseover="show_main_menu('<?php echo $mapping['Section_id'];?>', 'main')" <?php } else { ?> onmouseover="show_main_menu('<?php echo $mapping['sub_section'][0]['Section_id']; ?>','<?php echo $mapping['Section_id'];?>')"  <?php }?> href="<?php echo $MainSectionPageURL; ?>"><?php echo preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$mapping['SectionnameInHTML']); ?></a>
            <?php
						}
          ...
          <li class="<?php  if(!empty( $mapping['sub_section']) && $Section_Details['Sectionname'] != "Magazine") { echo "CitiesHover";  } else { echo "StatesHover";  } ?>" ><a class="MenuItem active"  id="maintabs-<?php echo $mapping['Section_id']; ?>" <?php if(count($mapping['sub_section']) == 0) { ?> onmouseover="show_main_menu('<?php echo $mapping['Section_id'];?>', 'main')" <?php } else { ?> onmouseover="show_main_menu('<?php echo $mapping['sub_section'][0]['Section_id']; ?>','<?php echo $mapping['Section_id'];?>')"  <?php }?> href="<?php echo $MainSectionPageURL; ?>"><?php echo preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$mapping['SectionnameInHTML']); ?></a>
            <?php
						...
						{ 
				 ?>
          <li class="<?php  if(!empty( $mapping['sub_section']) && $Section_Details['Sectionname'] != "Magazine") { echo "CitiesHover";  } else { echo "StatesHover";  } ?>" ><a class="MenuItem"  id="maintabs-<?php echo $mapping['Section_id']; ?>" <?php if(count($mapping['sub_section']) == 0) { ?> onmouseover="show_main_menu('<?php echo $mapping['Section_id'];?>', 'main')" <?php } else { ?> onmouseover="show_main_menu('<?php echo $mapping['sub_section'][0]['Section_id']; ?>','<?php echo $mapping['Section_id'];?>')"  <?php }?> href="<?php echo $MainSectionPageURL; ?>"><?php echo preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$mapping['SectionnameInHTML']); ?></a>
            <?php
						}
            ...
            <div class="MultiCities" id="tabs<?php echo $mapping['Section_id']; ?>">
              ...
              <div class="MultiCitiesContents tab-content">
                ...
                <div class="MultiCitiesCont tab-pane" id="tabs-<?php echo $sub_section['Section_id'];?>">
                   <!--  Sub tabs menu content appear here -->
                </div>
                <?php }
					}?>
          ...
          <li class="AllSectionHover" id="AllSectionHoverId"><a class="MenuItem" href="javascript:void(0);">All Sections &nbsp;<i class="fa fa-chevron-down"></i></a>
            <div class="MultiSection">
              ...
              <div class="MultiSectionList" style="width: 16%;"> <a class="AllTopic" href="<?php echo base_url()."opinions"; ?>"><?php echo "Opinions"; ?></a> <a class="AllTopic" href="<?php echo base_url()."opinions/editorials"; ?>"><?php echo "Editorials"; ?></a> <a class="AllTopic" href="<?php echo base_url()."ask-prabhu"; ?>"><?php echo "Ask Prabhu"; ?></a> <a class="AllTopic" href="<?php echo base_url()."opinions/columns"; ?>"><?php echo "Columns"; ?></a> <a class="AllList" href="<?php echo base_url()."opinions/columns/prabhu-chawla"; ?>"><?php echo "Prabhu Chawla"; ?></a> <a class="AllList" href="<?php echo base_url()."opinions/columns/t-j-s-george"; ?>"><?php echo "T J S George"; ?></a> <a class="AllList" href="<?php echo base_url()."opinions/columns/s-gurumurthy"; ?>"><?php echo "S Gurumurthy"; ?></a> <a class="AllList" href="<?php echo base_url()."opinions/columns/ravi-shankar"; ?>"><?php echo "Ravi Shankar"; ?></a> <a class="AllList" href="<?php echo base_url()."opinions/columns/shankkar-aiyar"; ?>"><?php echo "Shankkar Aiyar"; ?></a> <a class="AllList" href="<?php echo base_url()."opinions/columns/shampa-dhar-kamath"; ?>"><?php echo "Shampa Dhar-Kamath"; ?></a> <a class="AllList" href="<?php echo base_url()."opinions/columns/karamatullah-k-ghori"; ?>"><?php echo "Karamatullah K Ghori"; ?></a> </div>
