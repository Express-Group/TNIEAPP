													...
													{													
														...
														foreach($widget_instance_contents as $get_content)
														{
															...
															// Assign summary block - creating links for  article summary
																...
																$show_simple_tab.=	' <div class="LifeLeadLeft"> <figure class="PositionRelative"><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a> <div class="TransLarge">
    '.$display_title.'
																</div> </figure></div>';
																...
																else
																{
																	if($i==2){
																	 ...
																	 $show_simple_tab.=	'<figure class="PositionRelative"><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"> <div class="TransSmall">
      '.$display_title.'
																</div> </figure>';
