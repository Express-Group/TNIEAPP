	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="accordion" <?php echo $widget_bg_color;?>>
			<div class="panel-group" id="accordion_<?php echo $widget_instance_id;?>">
				...
				<div class="panel panel-default">
					<div class="panel-heading collapsed" data-toggle="collapse" id="most_read" onclick="show_accordian_articles('most_read')" data-parent="#accordion_<?php echo $widget_instance_id;?>" data-target="#collapse3_<?php echo $widget_instance_id;?>">
						<h3 class="panel-title"> <a class="accordion-toggle"> Most Read Articles <i class="fa fa fa-chevron-up pull-right"></i> <i class="fa fa fa-chevron-down pull-right"></i> </a> </h3>
					</div>
					<div id="collapse3_<?php echo $widget_instance_id;?>" class="panel-collapse collapse">
...
<script>
 function show_accordian_articles(content_type){
		 $.ajax({
			...
			method		: 'get',
			data		: { type: content_type, param: '<?php echo $content['page_param'];?>',mode:'<?php echo $view_mode;?>'},
			beforeSend	: function() {				
			},
...
show_accordian_articles('editor_pick');
});	   
</script>