...
$show_simple_tab    .='<div class="row">
                     ...
                     // $show_simple_tab    .=' <div class="SundayLead" '.$widget_bg_color.'>';
...
if(count($widget_contents)>0)
{
	foreach($widget_contents as $get_content)
	{
		...
		{
			 $show_simple_tab    .=' <div class="SundayLead" '.$widget_bg_color.'>';
		$show_simple_tab.=	' <div class="SundayLeadLeft"> <a  href="'.$live_article_url.'" class="article_click"  >
		<img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><h4 class="subtopic">'.$display_title.'</h4></a>';
		...
		{
		$show_simple_tab.=	' <div class="SundayLeadMiddle"> <a  href="'.$live_article_url.'" class="article_click"  >
		<img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><h4 class="subtopic">'.$display_title.'</h4></a>';
			if($is_summary_required== 1)
			{
			$show_simple_tab.='<p class="summary">'.$summary.'</p>';
		...
		else
	    {
			...
			<img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><h4 class="subtopic">'.$display_title.'</h4>';
