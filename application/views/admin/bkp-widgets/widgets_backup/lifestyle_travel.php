...
if(count($widget_contents)>0)
{
	foreach($widget_contents as $get_content)
	{
		...
		if($i == 1) 
		{
			...
			<img src="'.$dummy_image.'" data-src="'.$show_image.'"  title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></figure><div class="BgBlue">
			<h2 class="subtopic">'.$display_title.'</h2>';
		...
		else 
		{
			...
			$show_simple_tab.=	'</div>  <div class="LifeStylesRightImg"><a  href="'.$live_article_url.'" class="article_click" >
			<img src="'.$dummy_image.'" data-src="'.$show_image.'"  title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a> </div></div>';
