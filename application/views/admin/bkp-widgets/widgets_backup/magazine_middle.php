...
{
	$get_content_ids = array_map(function($element)
	{
		return $element['content_id'];
	}, $widget_instance_contents);
}
...
if($content_id != '')
{
	$widget_instance_contents2 = $this->widget_model->get_contentdetails_from_database_per_page($content_id, $content_type, $is_home, $view_mode, $start, $limit);
	...
	if(count($widget_contents) > 0)
	{
		foreach($widget_contents as $get_content)
		{
			...
			{
				//$show_simple_tab.= '<div class="col-sm-12"><p class="load_more_archive" style="margin-bottom:10px; "><a style="font-family: Arial !important; font-weight: normal;"  href="'.$load_more_url.'">More from Archieve</a></p></div>';
