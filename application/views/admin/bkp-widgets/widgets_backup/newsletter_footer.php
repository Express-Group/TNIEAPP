...
<tbody><tr>
<td valign="top" align="center" height="42" bgcolor="#337ab7"><a href="<?php echo $social_urls['facebook_url'];?>" target="_blank" class="buttonsAndImagesLink"><img src="<?php echo base_url(); ?>/images/FrontEnd/images/socialFacebook.jpg" style="display:block;" alt="" border="0" align="top" hspace="0" vspace="0" width="42" height="42"></a></td>

<td valign="top" align="center" height="42" bgcolor="#337ab7"><a href="<?php echo $social_urls['google_plus_url'];?>" target="_blank" class="buttonsAndImagesLink"><img src="<?php echo base_url(); ?>/images/FrontEnd/images/socialGoogle.jpg" style="display:block;" alt="" border="0" align="top" hspace="0" vspace="0" width="42" height="42"></a></td>

<td valign="top" align="center" height="42" bgcolor="#337ab7"><a href="<?php echo $social_urls['twitter_url'];?>" target="_blank" class="buttonsAndImagesLink"><img src="<?php echo base_url(); ?>/images/FrontEnd/images/socialTwitter.jpg" style="display:block;" alt="" border="0" align="top" hspace="0" vspace="0" width="42" height="42"></a></td>

<td valign="top" align="center" height="42" bgcolor="#337ab7"><a href="<?php echo $social_urls['rss_url'];?>" target="_blank" class="buttonsAndImagesLink"><img src="<?php echo base_url(); ?>/images/FrontEnd/images/socialRss.jpg" style="display:block;" alt="" border="0" align="top" hspace="0" vspace="0" width="42" height="42"></a></td>
