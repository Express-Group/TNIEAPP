...
$show_simple_tab .='<div class="row">
            ...
            <div class="city_lead" '.$widget_bg_color.'>';
													...
													{													
														...
														{
															//$widget_instance_contents = $this->widget_model->get_all_available_gallery_auto($content['show_max_article'], $widget_instancemainsection[$j]['Section_ID'], $content['mode']);
...
<a   href="'.$live_string_value.'"  class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><img src="'.image_url. imagelibrary_image_path.'gallery-icon.png" class="GalleryIcon GalleryIconTop"></a></figure><h4 class="subtopic">'.$display_title.'</h4>
																</div>';
