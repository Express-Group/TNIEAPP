<?php
			...
			<article class="WidthFloat_L printthis">
             ...
             if($sub_section['IsSubSection'] =='1'&& $sub_section['ParentSectionID']!=''&& $sub_section['ParentSectionID']!=0 ){
					...
					$section_link = '<a href="'.$domain_name.'">'.$home_section_name.'</a> <i class="fa fa-angle-right"></i> <a href="'.$domain_name.$grand_parent_section_name.'">'.$grand_parent_section_name1.'</a> <i class="fa fa-angle-right"></i> <a href="'.$domain_name.$parent_section_name.'">'.$parent_section_name1.'</a> <i class="fa fa-angle-right"></i> <a href="'.$domain_name.$child_section_name.'">'.$child_section_name1.'</a>';
					}else{
					$section_link = '<a href="'.$domain_name.'" >'.$home_section_name.'</a> <i class="fa fa-angle-right"></i> <a href="'.$domain_name.$parent_section_name.'">'.$parent_section_name1.'</a> <i class="fa fa-angle-right"></i> <a href="'.$domain_name.$child_section_name.'">'.$child_section_name1.'</a>';
					}
					}else{
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail">
    <?php 		
					...
					$author_pos  = stripos($author_name, $child_section_name1);
