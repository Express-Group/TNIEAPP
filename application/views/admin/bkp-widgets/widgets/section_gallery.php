...
if(count($widget_contents)>0)
{
	...
	<a  href="'.$live_article_url.'" class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'">
	<img class="GalleryIcon" src="'.$play_gallery_image.'"></a>
