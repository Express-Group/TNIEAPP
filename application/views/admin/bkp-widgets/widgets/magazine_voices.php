...
$show_simple_tab    .='<div class="row">
                       ...
                       <div class="MagazinesVoices features" '.$widget_bg_color.'>';
...
if($i==1)
{
$show_simple_tab.=	'<div class="MagazinesVoice slide MagazinesVoiceSlide">';
}

$show_simple_tab.=	'<div class="MagazinesVoiceItem"><div class="MagazinesVoiceImg"><a  href="'.$live_article_url.'" class="article_click"  ><img  src="'.$show_image.'"  title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a></div><div class="MagazinesVoiceCont"><span class="VoiceContTopic"><a href="'.$url_section_value.'" >'.$author_name.'</a></span><p> '.$display_title.'
</p></div></div>';
