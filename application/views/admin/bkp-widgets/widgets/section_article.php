...
if(count($leadstory) > 0)
{
	...
	{
		$widget_instance_contents = $this->widget_model->get_all_available_articles_auto($sec_leadstory_max_article, $main_sction_id, $content_type, $view_mode);
	}
	
	/*if(count($leadstory_content_array) == 0) // if sub section lead story manual mode with no articles added
	{
		$leadstory_content_array = $this->widget_model->get_all_available_articles_auto($max_article, $main_sction_id, $content_type, $view_mode);
	}*/
	//$widget_instance_contents = $leadstory_content_array;
}
/*else
{
	$widget_instance_contents = $this->widget_model->get_all_available_articles_auto($max_article, $main_sction_id, $content_type, $view_mode);
