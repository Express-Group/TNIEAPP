...
{ 
	...
	/*$subsec_leadstory_instancemainsection	= $this->widget_model->get_widget_mainsection_config_rendering('', $subsec_leadstory_instanceID, $view_mode);
	echo '<pre>'; print_r($subsec_leadstory_instancemainsection); die();
	$subsec_leadstory_mainsection_id = $subsec_leadstory_instancemainsection[0]['WidgetInstanceMainSection_id'];*/
}
