  ...
  $('#vertical-ticker_<?php echo $widget_instance_id; ?>').totemticker({ 
	...
	$('#add_article_process_img'+stateid).css('display','block');
		 $.ajax({
			...
			method		: 'post',
			data		: { stateid: stateid,widgetinstanceid: '<?php echo $widget_instance_id;?>',mode: '<?php echo $content['mode'];?>', 'rendermode' : '<?php echo $content['RenderingMode'];?>', is_home : '<?php echo $is_home;?>', max_article : '<?php echo $content['show_max_article'];?>', summary_option: '<?php echo $is_summary_required;?>',param : '<?php echo $content['page_param'];?>',tab_url: tab_url_structure, },
			beforeSend	: function() {				
