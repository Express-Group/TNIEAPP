...
if($get_content_ids!='')
{
	...
	{	
		...
		foreach($widget_contents as $get_content)
		{
		 ...
		 $summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);			// Assign summary block starts here
			
			////////  For first Article  /////////
			if($i<=2)
			{
				$show_simple_tab .='<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><div class="papers margin-bottom-15">';
