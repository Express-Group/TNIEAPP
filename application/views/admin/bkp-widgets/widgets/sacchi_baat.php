...
{
	$show_simple_tab .= ' <h2 class="PrabhuPower PrabhuBaat"><a href="' . $widget_section_url . '">' . $widget_custom_title . '</a></h2>';
}
else
{
	$show_simple_tab .= ' <h2 class="PrabhuPower PrabhuBaat">' . $widget_custom_title . '</h2>';
}
