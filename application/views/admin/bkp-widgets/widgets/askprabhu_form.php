...
$(document).ready(function()
	...
	$("#btnPost").click(function() 
		{
			if($("#AskPrabhuForm").valid())
			{
				...
				$.ajax({
						...
						url:"<?php echo base_url(); ?>niecpan/askprabhu/check_capicha",
	...
	$("#btnrefresh").on("click", function()
	{
    	...
    	img.src = '<?php echo base_url();?>niecpan/askprabhu/capicha?timestamp=' + new Date().getTime();
...
<button name="submit" class="btnRefresh FloatLeft" onclick="refreshCaptcha();"><i class="fa fa-refresh"></i></button>
								...
								<td><div class="AskPrabhuCaptcha"> <img id="captcha_code" class="CaptchaImg" src="<?php echo base_url();?>niecpan/askprabhu/capicha" alt="" /> <span id="captcha-info" class="info"></span>
										<div class="CaptchaBack">
...
<script>
		function post_questions()
		{
			...
			$.ajax({
						...
						url:"<?php echo base_url(); ?>niecpan/askprabhu/add_askprabhuquestion",
						success: function(result)
						{
							//console.log(result);
							if(result=="success")
