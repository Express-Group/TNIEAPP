...
<p>If you still have difficulty finding what you need, please <a href="<?php echo base_url();?>">click here</a> to go to the homepage or here to <a href="<?php echo base_url();?>contact_us">contact us</a>.</p>
