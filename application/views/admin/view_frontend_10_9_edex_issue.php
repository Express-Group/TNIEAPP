<?php
   ...
   // $ExpireTime = 60; // seconds (= 1 mins)
	...
	$this->output->set_header("Cache-Control: max-age=".$ExpireTime.", must-revalidate");
...
<html lang="en">
  ...
  <link rel="stylesheet" href="<?php echo $css_path; ?>css/custom.min.css" type="text/css"> 
  ...
  <script type="application/ld+json">
	...
	<?php if(strtolower($section_details['URLSectionStructure'])!='adcheck'): ?>
...
<!-- /3167926/NIE_home_ad_tag_1_1x1 -->
<div id='div-gpt-ad-1529055706799-6' style='height:1px; width:1px;'>
	<script>
	googletag.cmd.push(function() { googletag.display('div-gpt-ad-1529055706799-6'); });
	</script>
</div>
<?php }
echo $header;
...
<?php if(strtolower($section_details['URLSectionStructure'])=='testing'){ ?>
<script type="text/javascript"><!--
  e9 = new Object();
  e9.snackbar = true;
//--></script>
<script type="text/javascript" src="//tags.expo9.exponential.com/tags/VDX/ConnectMobileExpandable/tags.js"></script>
<?php } ?>
<?php
$countryCode = ['US','EU'];
