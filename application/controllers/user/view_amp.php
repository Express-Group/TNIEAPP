...
<html amp>
	<head>
		...
		<style amp-custom>
			...
			amp-web-push-widget.amp-invisible{visibility: hidden;display: none;}
			amp-web-push-widget button.subscribe , amp-web-push-widget button.unsubscribe{display: inline-flex;align-items: center;border-radius: 2px;border: 0;box-sizing: border-box;margin: 0;padding: 8px 15px;cursor: pointer;outline: none;font-size: 15px;font-weight: 400;background: #09155E;color: white;box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.5);-webkit-tap-highlight-color: rgba(0, 0, 0, 0);}
			...
			amp-web-push-widget button.unsubscribe{background: red;}
			amp-web-push-widget{margin : 0 22%;}
	...
	<body>
		...
		<article class="article">
			...
			<p class="adv-div">
			<amp-ad width=300 height=250 type="doubleclick" data-slot="/3167926/NIE_AMP_ATF_300x250"    data-multi-size-validation="false"></amp-ad>
			</p>
			<?php
			...
			foreach ($ptag as $p){
				if($i==3){
					...
					$advContent = "<amp-ad width=300 height=250 type=\"doubleclick\" data-slot=\"/3167926/NIE_AMP_MID_300x250\" data-multi-size-validation=\"false\"></amp-ad>";
			...
			<?php endif; ?>
			<p class="adv-div"><amp-ad width=300 height=250
				type="doubleclick"
				data-slot="/3167926/NIE_AMP_BTF_300x250"
		...
		if($Details[0]->tags!=''):
			...
			<amp-sticky-ad layout="nodisplay">
				<amp-ad width=320 height=50
					type="doubleclick"
					data-slot="/3167926/NIE_AMP_Sticky_320x50"
					data-multi-size-validation="false">
				</amp-ad>
			</amp-sticky-ad>
			<amp-web-push
			  id='amp-web-push'
			  layout='nodisplay'
			  helper-iframe-url='https://www.newindianexpress.com/amp-helper-frame.html?appId=685f8f84-a8d6-402c-bfea-dcb4208e'
			  permission-dialog-url='https://www.newindianexpress.com/amp-permission-dialog.html?appId=685f8f84-a8d6-402c-bfea-dcb4208e'
			  service-worker-url='https://www.newindianexpress.com/service-worker.js?appId=685f8f84-a8d6-402c-bfea-dcb4208e'
			></amp-web-push>
			...
			<button class="subscribe" on="tap:amp-web-push.subscribe">
			  <amp-img
				  ...
				  AAAAYBAMAAAASWSDLAAAAJFBMVEUAAAD
				  ...
				  AopgIAIdhOgWU6qvUAAAAASUVORK5CYII="></amp-img>
			...
			?>
			<p class="adv-div">
			<amp-ad width=320 height=3120
					type="doubleclick"
					data-slot="/3167926/NIE_AMP_Native_320x3120"
					data-multi-size-validation="false">
			</amp-ad>
			</p>
