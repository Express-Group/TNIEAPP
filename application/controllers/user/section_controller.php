...
class Section_controller extends CI_Controller {
	...
	public function index()
	{
		...
		// $fullURL = str_replace('www.newindianexpress.com' , 'cms.newindianexpress.com',$fullURL);
		// $content = file_get_contents($fullURL);
		// $content = str_replace('cms.newindianexpress.com' , 'www.newindianexpress.com' ,$content);
		// echo $content;
		// exit;
		$view_mode           = "live";
