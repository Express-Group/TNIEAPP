...
class Commonwidget extends CI_Controller 
{
	...
	public function getsponsorarticles(){
		...
		foreach($articledetails as $sponsorarticles):
			 ...
			 $template .='<p><i class="fa fa-caret-right" aria-hidden="true" style="color:#337ab7;"></i><a href="'.base_url().$sponsorarticles->url.'">'.$content_title.'</a></p>';
		endforeach;
		echo $template; 
	}
	...
	public function GetDynamicTables(){
		...
		if($Data=='NO ROWS'){
			...
			foreach($Data as $Datavalue):
				...
				$Template .='<div class="col-md-6 dynamic-table-width">';
